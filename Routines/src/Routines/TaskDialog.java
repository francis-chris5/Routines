...
/**
 * The Java class to accompany a GUI constructed in FXML. Basically this take the data from a Task object and sets it up to be displayed nicely on the screen for a user.
